...
To use the script, simply update the dataset path in the code and run **trainNet.m** in MATLAB. The script will automatically manage data preparation, training, and saving of the trained model.
